...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    List_List$from(elements, $E) {
      ...
      for (t1 = A._LinkedHashSetIterator$(elements, elements._collection$_modifications, elements.$ti._precomputed1), t2 = t1.$ti._precomputed1; t1.moveNext$0();) {
        t3 = t1._collection$_current;
        B.JSArray_methods.add$1(list, $E._as(t3 == null ? t2._as(t3) : t3));
      }
      return list;
    },
    ...
    main() {
      A.createFlintApp("#app", A.LinkedHashMap_LinkedHashMap$_literal(["Dashboard", new A.main_closure()], type$.String, type$.FlintComponent_Function_Map_String_dynamic), $.$get$appRootDesign());
    },
  ...
  A.StateSignal.prototype = {
    ...
    notifyListeners$0() {
      var t1, t2, _i;
      for (t1 = A.List_List$from(this._listeners, this.$ti._eval$1("~(1)")), t2 = t1.length, _i = 0; _i < t2; ++_i)
  ...
  A.StateSignalListener__bindSignal_closure.prototype = {
    call$1(__wc0_formal) {
      ...
      type$.void_Function._as(new A.StateSignalListener__bindSignal__closure()).call$0();
  ...
  A.DartStyle.prototype = {
    toMap$0() {
      var t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, t30, t31, t32, t33, t34, t35, t36, t37, t38, t39, t40, t41, t42, t43, t44, t45, t46, _this = this, _null = null,
        t1 = _this.padding;
      ...
      t46 = _this.shadow;
      t46 = t46 instanceof A.Shadow ? t46.toCss$0() : A.cssValue(t46, false);
      return A._withoutNulls(A.LinkedHashMap_LinkedHashMap$_literal(["padding", t1, "margin", t2, "width", t3, "height", t4, "min-width", t5, "max-width", t6, "min-height", t7, "max-height", t8, "display", t9, "gap", t10, "align-items", t11, "justify-items", t12, "justify-content", t13, "flex", t14, "flex-direction", t15, "flex-wrap", t16, "flex-grow", t17, "flex-shrink", t18, "flex-basis", t19, "grid-template-columns", t20, "position", null, "top", t21, "right", t22, "bottom", t23, "left", t24, "z-index", _this.zIndex, "overflow", t25, "box-sizing", t26, "scroll-behavior", t27, "aspect-ratio", t28, "object-fit", t29, "transform", t30, "backdrop-filter", t31, "mask-image", t32, "font-family", t33, "font-size", t34, "font-weight", t35, "line-height", t36, "letter-spacing", t37, "color", t38, "text-align", null, "text-transform", t39, "text-decoration", t40, "cursor", t41, "resize", t42, "background", t43, "border-radius", t44, "border", t45, "border-top", null, "border-right", null, "border-bottom", null, "border-left", null, "box-shadow", t46, "opacity", _this.opacity, "transition", A.cssValue(_this.transition, true), "animation", A.cssValue(_this.animation, true), "will-change", A.cssValue(_this.willChange, true)], type$.String, type$.nullable_Object));
    },
    ...
    merge$1(override) {
      ...
      t15 = override.gridTemplateColumns;
      if (t15 == null)
        t15 = _this.gridTemplateColumns;
      t16 = override.boxSizing;
      if (t16 == null)
        t16 = _this.boxSizing;
      t17 = override.transform;
      if (t17 == null)
        t17 = _this.transform;
      ...
      if (t33 == null)
        t33 = _this.active;
      return A.DartStyle$(t33, t10, _this.animation, _this.aspectRatio, _this.backdropFilter, t25, t27, _this.borderBottom, _this.borderLeft, _this.borderRight, _this.borderTop, _this.bottom, t16, _this.checked, t22, t24, _this.disabled, t8, _this.expanded, t13, _this.flexBasis, t14, _this.flexGrow, _this.flexShrink, _this.flexWrap, _this.focus, t32, t18, t19, t20, t9, _this.gradient, t15, t4, t31, _this.invalid, t12, t11, _this.left, _this.letterSpacing, _this.lg, t21, t2, _this.maskImage, _this.maxHeight, t6, _this.md, t7, t5, _this.objectFit, t29, _this.overflow, t1, _this.position, t26, _this.resize, _this.right, _this.scrollBehavior, _this.selected, t28, _this.sm, _this.textAlign, t23, _this.textTransform, _this.top, t17, t30, t3, _this.willChange, _this.xl, _this.zIndex);
    }
  };
  ...
  A.DashboardSidebar.prototype = {
    build$0() {
      return new A.PageAside(B.DartStyle_zgM, [A.Row$([new A.LogoMark(), A.Text_span("Flint HQ", B.DartStyle_Vur)], B.DartStyle_QkX), new A.PageNav(B.DartStyle_VwA, [new A.DashboardNavItem("Overview", true), new A.DashboardNavItem("Customers", false), new A.DashboardNavItem("Billing", false), new A.DashboardNavItem("Reports", false)]), new A.Container("div", A.mergeComponentProps(B.Map_empty1, null, B.DartStyle_pAJ0, B.Map_empty1, B.Map_empty1), A.normalizeChildren(null, B.List_empty1)), new A.TextLink("Login screen", "/login", B.DartStyle_vl2)]);
    }
  };
  A.DashboardTopbar.prototype = {
    build$0() {
      var t7, _null = null,
        t1 = A.Column$([A.Text_p("Good morning, " + this.name, B.DartStyle_Y6Z), A._element("h1", "Business overview", _null, B.Map_empty1, B.Map_empty1, B.DartStyle_pON)], _null),
        t2 = this.loading,
        t3 = t2 ? "Refreshing" : "Refresh API",
        t4 = type$.String,
        t5 = type$.nullable_Object,
        t6 = A.LinkedHashMap_LinkedHashMap$of(B.Map_empty1, t4, t5);
      t6.$indexSet(0, "type", "button");
      if (t2)
        t6.$indexSet(0, "disabled", true);
      if (t2)
        t6.$indexSet(0, "aria-busy", "true");
      t7 = !t2;
      if (t7)
        t6.$indexSet(0, "onClick", new A.DashboardTopbar_build_closure(this));
      t6 = A.mergeComponentProps(t6, _null, A.buttonComponentStyle(false, t2, B.ComponentSize_2, B.Tone_1, B.ButtonVariant_0).merge$1(B.DartStyle_omt), B.Map_empty1, B.Map_empty1);
      t7 = A._setArrayType([], type$.JSArray_FlintNode);
      if (t2) {
        t2 = A.LinkedHashMap_LinkedHashMap$of(B.Map_empty1, t4, t5);
        t2.$indexSet(0, "role", "status");
        t2.$indexSet(0, "aria-label", "Loading");
        t2 = A.mergeComponentProps(t2, _null, _null, A.LinkedHashMap_LinkedHashMap$_literal(["display", "inline-block", "width", A.spinnerSize(B.ComponentSize_0), "height", A.spinnerSize(B.ComponentSize_0), "border", "2px solid " + A.toneSoft(B.Tone_1), "border-top-color", A.toneSolid(B.Tone_1), "border-radius", "999px", "animation", A.cssValue(A.StyleAnimation_StyleAnimation$named("flint-spin", B.C_AnimationIteration, 800, B.TransitionTiming_linear), false), "will-change", A.cssValue(B.C_WillChange, false), "flex-shrink", 0], t4, t5), B.Map_empty1);
        t7.push(new A.Spinner("span", t2, B.List_empty2));
      }
      B.JSArray_methods.addAll$1(t7, A.normalizeChildren(t3, B.List_empty1));
      return new A.HeaderBlock(B.DartStyle_xNo, [t1, new A.Button("button", t6, t7)]);
    }
  };
  ...
  A.LogoMark.prototype = {
    build$0() {
      return new A.Container("div", A.mergeComponentProps(B.Map_empty1, null, B.DartStyle_uyH, B.Map_empty1, B.Map_empty1), A.normalizeChildren(new A.Text("F"), B.List_empty1));
    }
  };
  A.MetricCard.prototype = {
    build$0() {
      ...
      t3 = t1.$index(0, "value");
      t3 = A._element("strong", t3 == null ? "" : t3, null, B.Map_empty1, B.Map_empty1, B.DartStyle_EqI);
      t1 = t1.$index(0, "delta");
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "component_props__toFlintNode$closure", "toFlintNode", 41);
    _instance_0_u(A.StateSignalListener.prototype, "get$didMount", "didMount$0", 0);
    _static_1(A, "style___gradientStopValue$closure", "_gradientStopValue", 11);
    ...
    _static_0(A, "sample_api_client_SampleApiClient_dashboard$closure", "SampleApiClient_dashboard", 28);
  })();
  (function inheritance() {
    ...
    _inheritMany(A._Enum, [A.FlintErrorKind, A.FlintResponseType, A.ResourceStatus, A.Display, A.FlexDirection, A.AlignItems, A.JustifyContent, A.Tone, A.ComponentSize, A.ButtonVariant]);
...
;
    ...
    B.DartStyle_pAJ0 = new A.DartStyle(null, null, null, null, null, null, null, null, null, null, null, null, null, 1, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    B.List_empty3 = makeConstList([], A.findType("JSArray<Map<String,String>>"));
    ...
    B.Map_empty2 = new A.ConstantStringMap(B.Object_empty, [], A.findType("ConstantStringMap<String,String>"));
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "buttonBaseStyle", "$get$buttonBaseStyle", () => {
      var _null = null;
      return A.DartStyle$(_null, B.AlignItems_center_1_center, _null, _null, _null, _null, A.Border$all(B.Color_transparent), _null, _null, _null, _null, _null, _null, _null, _null, B.Cursor_pointer, _null, B.Display_eAD, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 600, 8, _null, _null, _null, _null, _null, B.JustifyContent_center_1_center, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 8, _null, _null, _null, _null, _null, _null, _null, B.C_TextDecorationStyle, _null, _null, _null, A.StyleTransition_StyleTransition$combine(A._setArrayType([A.StyleTransition_StyleTransition$property("color", 120, B.TransitionTiming_ease), A.StyleTransition_StyleTransition$property("background", 120, B.TransitionTiming_ease), A.StyleTransition_StyleTransition$property("border-color", 120, B.TransitionTiming_ease)], A.findType("JSArray<StyleTransition>"))), _null, _null, _null, _null);
    });
    _lazyFinal($, "appRootDesign", "$get$appRootDesign", () => {
      ...
      t2 = A._setArrayType([A.Gradient_Gradient$radialCircle(B.GradientPosition_aOE, B.List_vU6), A.Gradient_Gradient$radialCircle(B.GradientPosition_yg7, B.List_4CD), B.Color_VcK], type$.JSArray_Object);
      if (B.JSArray_methods.get$isEmpty(t2))
        A.throwExpression(A.ArgumentError$value(t2, "layers", "Must not be empty."));
      return A.RootDesign$(B.DartStyle_jTt, A.DartStyle$(_null, _null, _null, _null, _null, new A.Background(B.JSArray_methods.map$1$1(t2, A.style__cssValue$closure(), type$.String).join$1(0, ", ")), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.EdgeInsets_0_0_0_0, _null, _null, _null, _null, _null, 320, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null), A._setArrayType([A.StyleKeyframes_spin(), A.StyleKeyframes_fadeIn()], type$.JSArray_StyleKeyframes), B.DartStyle_rqX, "sample", t1, B.Map_b8RkP, B.C_FlintTheme);
    });
  })();
...
//# sourceMappingURL=dashboard.f7faee6e7c91.dart.js.map
