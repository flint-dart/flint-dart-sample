...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      A.createFlintApp("#app", A.LinkedHashMap_LinkedHashMap$_literal(["Login", new A.main_closure()], type$.String, type$.FlintComponent_Function_Map_String_dynamic), $.$get$appRootDesign());
    },
  ...
  A.AuthFormPanel.prototype = {
    build$0() {
      var t4, t5, t6, t7, t8, _null = null,
        _s8_ = "password",
        t1 = [A.Row$([A.Text_span("Login", B.DartStyle_nsk), new A.TextLink("Create account", "/register", B.DartStyle_7xw)], B.DartStyle_eKp)],
        t2 = this.shell,
        t3 = t2.statusMessage;
      if (t3.length !== 0)
        t1.push(new A.AuthStatusMessage(t3, t2.statusSuccess));
      t3 = type$.nullable_Object;
      t4 = A.List_List$_of([t2.field$4("Email address", "email", "email", "you@company.com"), t2.field$4("Password", _s8_, _s8_, "Enter password")], t3);
      ...
      B.JSArray_methods.addAll$1(t8, A.normalizeChildren("Sign in", B.List_empty2));
  ...
  A.AuthPageShell_submit_closure1.prototype = {
    call$0() {
      ...
      t2 = this.name;
      t1.statusMessage = t2 == null ? "Login request completed." : "Login request completed for " + t2 + ".";
    },
    $signature: 0
  };
  ...
  (function inheritance() {
    ...
    _inherit(A.LoginPage, A.AuthPageShell);
...
//# sourceMappingURL=login.ea288d28b5ba.dart.js.map
